...
The goal of this practice is to complete the code of the project to:
*	Configure filebeats to read the nginx log and send to logstash
*	Configure Logstash to parse the nginx log and save the information to elasticsearch
*	Create a simple dashboard to see some statistics collected
*	Ingest data into Elasticsearch using the python APIs
*	Complete the flask app to retrieve and visualize the documents stored in Elasticsearch

The solution is available at [elk-flask-nginx](https://github.com/alefiori82/elk-flask-nginx).
